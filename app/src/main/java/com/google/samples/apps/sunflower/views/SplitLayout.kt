...
class SplitLayout : FrameLayout {
    ...
    private lateinit var control: FrameLayout
    ...
    override fun onFinishInflate() {
        ...
        content = rootView.findViewById(R.id.content_layout)
        control = rootView.findViewById(R.id.control_layout)
    }

    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        if (windowLayoutInfo == null) return

        val splitPositions = splitViewPositions(content, control)
        ...
        if (splitPositions != null) {
            ...
            content.measure(startWidthSpec, startHeightSpec)
            content.layout(
            ...
            control.measure(endWidthSpec, endHeightSpec)
            control.layout(
